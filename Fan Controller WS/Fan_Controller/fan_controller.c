...
int main(void)
{
	...
	while(1)
	{
		...
		/*In case of (30 <= temperature < 60), Turn ON the fan with 25% of its maximum speed.*/
		...
		/*In case of (60 <= temperature < 90), Turn ON the fan with 50% of its maximum speed.*/
		...
		/*In case of (90 <= temperature < 120), Turn ON the fan with 75% of its maximum speed.*/
		...
		/*In case of (120 <= temperature), Turn ON the fan with its maximum speed.*/
		else if (temperature >= 120)
		{
			LCD_moveCursor(1,10);
			LCD_intgerToString(temperature);
